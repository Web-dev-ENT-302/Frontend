...
import { FaMoneyBill, FaStar } from 'react-icons/fa6'
                    ...
                    <div className='px-4 mt-1 mb-10 sm:mt-0 sm:mb-0 sm:pl-6 sm:pr-6 md:pr-16 sm:py-6 md:py-7'>
                            ...
                            <div className="w-full bg-white rounded-md shadow-[0px_0px_3px_rgba(0,0,0,0.1)] px-3 sm:px-4 py-4 sm:py-4">
                                <div className='w-full bg-[#FFF2E3] rounded-md py-3 px-3 sm:px-6 sm:py-4'>
                                    ...
                                    <div className='flex items-center gap-2 mt-2'>
                                        ...
                                        <span className='text-[--primary] text-[1rem] sm:text-[1.2rem] font-bold'>₦700.00</span>
                                    </div>
                                </div>
                                ...
                                <div className='grid grid-cols-2 gap-2 mt-4 sm:gap-4 md:grid-cols-4'>
                                    <div className='bg-[#F9F9F9] rounded-md p-3'>
                                        ...
                                        <p className='font-medium text-[1rem] sm:text-[1.2rem] mt-2'>5</p>
                                    </div>
                                    <div className='bg-[#F9F9F9] rounded-md p-3'>
                                        <span className='text-[#787878] text-[.8rem] sm:text-[.9rem]'>Avg. Rating</span>
                                    ...
                                    <div className='bg-[#F9F9F9] rounded-md p-3'>
                                        ...
                                        <p className='font-medium text-[1rem] sm:text-[1.2rem] mt-2'>9.3k km</p>
                                    </div>
                                    <div className='bg-[#F9F9F9] rounded-md p-3'>
                                        <span className='text-[#787878] text-[.8rem] sm:text-[.9rem]'>This Week</span>
                                        <p className='font-medium text-[1rem] sm:text-[1.2rem] mt-2'>₦9,750</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-10">
                            <div className='flex items-center justify-between'>
                                ...
                                <span className='bg-[--primary] text-white rounded-full px-[.45rem] py-[.1rem] sm:px-2 sm:py-[.1rem] text-[.7rem] sm:text-[.8rem]'>3</span>
                            </div>
