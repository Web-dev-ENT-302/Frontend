...
const RecentRides = ({ id, location, price, distance, estimatedTime, status, viewRideDetails }) => {

    return (

        <div className="p-4 bg-white rounded-[10px] shadow-[0px_0px_10px_rgba(0,0,0,0.04)] flex gap-3 items-center cursor-pointer hover:shadow-[0px_0px_10px_rgba(0,0,0,0.1)]  transition-all ease-linear" onClick={viewRideDetails}>
            <div className="w-full">
                ...
                <div className="flex items-center justify-between gap-6 mt-4 md:mt-6">
                    ...
                    <span className="flex items-center gap-1 font-medium text-[#787878]">
                        {/* <CgTrack /> */}
                        <p className="text-[.8rem] leading-none underline">View</p>
                    </span>
                </div>
            </div>
        </div>
